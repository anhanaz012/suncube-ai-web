...
export const metadata: Metadata = {
  title: "Suncube-AI - modern Agency and Portfolio Next js Template",
  description:
    "Suncube-AI is a modern agency and portfolio template built with Next.js, designed to showcase your work and services effectively.",
};
